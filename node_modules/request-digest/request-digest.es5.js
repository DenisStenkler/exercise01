...
var HTTPDigest = (function () {
    ...
    _createClass(HTTPDigest, [{
        ...
        value: function _handleResponse(options, res, callback) {
            ...
            // SET SOAP2 - CUSTOM
            //headers.SOAPAction = options.soap2;

            options.headers = headers;

            // SET BODY - CUSTOM
            // options.body = options.body2;

            // TESTING:
            // TESTING:
            //// TESTING:
            //options.headers['SOAPAction'] = options.soap2;
            ...
            //console.log('-------ttttt');
            //console.log('-------ttttt');
            //console.log(options.body2);
            //console.log(options.soap2);
            //console.log(options.headers);
            //console.log(options);
            //return;

            /*
            var calculated = options.headers['Authorization'];
            options.headers = null;
            options.headers = {
                'Content-Type': 'text/xml; charset=utf-8',
                'SOAPAction': 'http://purenetworks.com/HNAP1/SetAPClientSettings',
                'Content-Length': '1000',
                'Authorization': calculated
            };
